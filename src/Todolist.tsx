...
export function Todolist(props: PropsType) {
    ...
    if (filter === "Short_First_Three_Tasks") {
        tasksForTodolist = props.tasks.filter(t => t.id <= 3);
    }
    if (filter === "DelAll") {
        tasksForTodolist = props.tasks.filter(t => t.id === t.id + 1);
    }
    ...
    return <div>
        ...
        <div>
            ...
            <button onClick={() => { changeFilter("Short_First_Three_Tasks")}}>Show First Three Tasks</button>
        </div>
    </div>
}
